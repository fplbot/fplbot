...
public class MatchdayEventPublishingTests
{
    [Fact]
    ...
    private MatchdayEventPublishing CreateMatchDayStatusMonitor( )
    {
        return new(EventStatusClient, new TestScopeFactory(Mediator), A.Fake<ILogger<MatchdayEventPublishing>>());
    }

    ...
    private List<FixtureEvents> CreateIrrelevantEvents()
    {
        ...
        [
            ...
            (
                new FixtureScore
                (
                    new FixtureTeam(fixture.HomeTeamId, TestBuilder.HomeTeam().Name!,
                        TestBuilder.HomeTeam().ShortName!),
                    new FixtureTeam(fixture.AwayTeamId, TestBuilder.AwayTeam().Name!,
                        TestBuilder.AwayTeam().ShortName!),
                    85,
                    1,
                    0
                ),

...
public record ActionRow(
    ...
    IReadOnlyList<MessageComponent> Components) : MessageComponent;
...
public record Button(
    ...
    string? Label = null,
    [property: JsonPropertyName("custom_id"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    string? CustomId = null,
    [property: JsonPropertyName("url"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    string? Url = null,
    [property: JsonPropertyName("disabled"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    bool? Disabled = null) : MessageComponent;

public record Section(
    [property: JsonPropertyName("components")]
    IReadOnlyList<MessageComponent> Components,
    [property: JsonPropertyName("accessory"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    MessageComponent? Accessory = null) : MessageComponent;

public record TextDisplay(
    [property: JsonPropertyName("content")]
    string Content) : MessageComponent;
...
public record Thumbnail(
    ...
    [property: JsonPropertyName("spoiler"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    bool? Spoiler = null) : MessageComponent;
...
public record Separator(
    [property: JsonPropertyName("divider"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    bool? Divider = null,
    [property: JsonPropertyName("spacing"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    int? Spacing = null) : MessageComponent;

public record Container(
    [property: JsonPropertyName("components")]
    IReadOnlyList<MessageComponent> Components,
    [property: JsonPropertyName("accent_color"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]

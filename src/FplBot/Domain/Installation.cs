...
public class Installation
{
    ...
    private Installation(InstallationId id, string externalId, string name, string? token)
    {
        Id = id;
    ...
    public static Installation Install(string externalId, string name, string token) =>
        new(InstallationId.New(), externalId, name, token);

    public static Installation Install(string externalId, string name) =>
        new(InstallationId.New(), externalId, name, token: null);

    public static Installation Reinstall(InstallationId id, string externalId, string name, string token, IEnumerable<ChannelSubscription> existingChannels) =>
        Load(id, externalId, name, token, existingChannels);

    public static Installation Reinstall(InstallationId id, string externalId, string name, IEnumerable<ChannelSubscription> existingChannels) =>
        Load(id, externalId, name, token: null, existingChannels);

    public static Installation Load(InstallationId id, string externalId, string name, string? token, IEnumerable<ChannelSubscription> channelSubscriptions, bool pendingRemoval = false)
    {
        var installation = new Installation(id, externalId, name, token) { PendingRemoval = pendingRemoval };

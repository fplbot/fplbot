  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "slack/subscriptions/:subscriptionId",
          name: "admin-team-channel-manage",
          component: () => import("./views/admin/ChannelManageView.vue"),
          props: (route) => ({ subscriptionId: route.params.subscriptionId, adapter: slackInstallationAdapter }),
        },
        {
        ...
        {
          path: "discord/subscriptions/:subscriptionId",
          name: "admin-guild-channel-manage",
          component: () => import("./views/admin/ChannelManageView.vue"),
          props: (route) => ({ subscriptionId: route.params.subscriptionId, adapter: discordInstallationAdapter }),
        },
      ],
    },
    {

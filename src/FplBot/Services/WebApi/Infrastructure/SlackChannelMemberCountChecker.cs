...
public class SlackChannelMemberCountChecker(IServiceScopeFactory scopeFactory) : IRecurringAction
{
    public async Task Process(CancellationToken stoppingToken)
    {
        ...
        await scope.ServiceProvider.GetRequiredService<IPublishEndpoint>().Publish(new RefreshSlackReachStats(), stoppingToken);
    }

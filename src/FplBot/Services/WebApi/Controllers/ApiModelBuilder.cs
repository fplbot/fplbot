...
public static class ApiModelBuilder
{
    public static PLVirtualLeagueEntry BuildPLVirtualLeagueEntry(VerifiedPLEntry plEntry, VerifiedEntry fplEntry)
    {
        return new(
            ...
            ShirtImageUrl : $"https://fantasy.premierleague.com/dist/img/shirts/standard/shirt_{plEntry.TeamCode}-66.png",
            ImageUrl : $"https://resources.premierleague.com/premierleague/photos/players/110x140/p{plEntry.PlayerCode}.png",
...
public record PLVirtualLeagueEntry(
    int EntryId, string Slug, string TeamName, string RealName, string Alias, string Description,
    int? PLPlayerId, string PLName, string PlaysForTeam, string ShirtImageUrl, string ImageUrl,
    int? PointsThisGw, int? TotalPoints, int? OverallRank, int Movement, string Captain,
    string ViceCaptain, string ChipUsed, int SelfOwnershipWeekCount, int SelfOwnershipTotalPoints, int? Gameweek);

public record PLEntry(
    int EntryId, string Slug, string TeamName, string RealName, string Alias, string Description,
    int? PLPlayerId, string PLName, string PlaysForTeam, string ShirtImageUrl, string ImageUrl,
    int? PointsThisGw, int? TotalPoints, int? OverallRank, string Captain, string ViceCaptain,
    string ChipUsed, int SelfOwnershipWeekCount, int SelfOwnershipTotalPoints, int? Gameweek);

public record RegularVirtualLeagueEntry(
    int EntryId, string VerifiedType, string TeamName, string RealName, string Alias, string Description,
    int? PointsThisGw, int? TotalPoints, int? OverallRank, int Movement, string Captain,
    string ViceCaptain, string ChipUsed, int? Gameweek);

public record RegularEntry(
    int EntryId, string VerifiedType, string TeamName, string RealName, string Alias, string Description,
    int? PointsThisGw, int? TotalPoints, int? OverallRank, string Captain, string ViceCaptain,
    string ChipUsed, int? Gameweek);

...
public record SeedSelfishness(int EntryId);

public class SeedSelfishnessHandler : IConsumer<SeedSelfishness>
{
    ...
    public async Task Consume(ConsumeContext<SeedSelfishness> context)
    {

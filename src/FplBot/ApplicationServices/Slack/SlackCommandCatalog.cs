...
public static class SlackCommandCatalog
{
    ...
    public static readonly CommandHelp Captains = new("captains [chart] {GW-number, or empty for current}",
        "Display captain picks in the league. Add \"chart\" to visualize it in a chart.");
    ...
    public static readonly CommandHelp Subscribe = new("subscribe/unsubscribe {comma separated list of events}",
        $"Update what notifications fplbot should post. ({string.Join(", ", EventSubscriptionHelper.GetAllSubscriptionTypes())})");
